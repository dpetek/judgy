docker rm judgy-ambassador
docker run -d -v=/build -v /out --name=judgy-ambassador busybox:latest
...
docker run --rm --volumes-from judgy-ambassador -v /var/www/judge_data/submissions/549f2c0af171f45b618b4567/54a72c02f171f4a0238b4569:/solution c-build
